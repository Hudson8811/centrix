...
const scriptsPath = ['source/js/main.js'];
...
gulp.task('default', gulp.series('clean', 'copy', 'copyVendorCss', 'scripts', 'favicon', 'sprite', 'img', 'webp', parallel('sass', /*'sassLibs',*/ 'sassIntro', /*'php'*/), 'pug', 'server'));
